...
urlpatterns = [
                  ...
                  path('game/<int:pk>/shield/', views.GameViewSet.as_view({'post': 'shield'}), name='game-shield'),
                  path('game/<int:pk>/defend/', views.GameViewSet.as_view({'post': 'defend'}), name='game-defend'),
